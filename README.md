...
> **Статус:** ✅ работает в бою, первый портал подключён. Это **этап 0** большой
> системы работы с обращениями: что строим дальше — [`docs/PRODUCT.md`](docs/PRODUCT.md),
> этапы и критерии приёмки — [`docs/ROADMAP.md`](docs/ROADMAP.md), текущий срез —
